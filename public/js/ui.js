...
// Actualiza el socketId mostrado en el front mediante el ID del elemento. "PersonalCode es el (socket.id)"
...
// Nos muestra la llamada entrante de alguien que quiera comunicarse con nosotros por socket.id". Puede ser chat, video,y puede ser aceptada o rechazada.
...
// En caso de que el tipo de llamada sea "chat", abrimos el dialogo
...
// Respuesta a los distintos tipos de cancelacion de respuesta que tiene el evento "pre-offer" enviado por janus y pintamos dichas respuesta en el dialogo 
export const showInfoDialog = (preOfferAnswer) => {
  let infoDialog = null;

  // Cancelacion de la llamada
...
// Si cortamos la llamada, eliminar el dialogo
export const removeAllDialogs = () => {
  const dialog = document.getElementById("dialog");
  dialog.querySelectorAll("*").forEach((dialog) => dialog.remove());
};

// Mostrar los elementos de la llamada, dependiendo si es chat o video
...
// Mostrar los elementos de video
